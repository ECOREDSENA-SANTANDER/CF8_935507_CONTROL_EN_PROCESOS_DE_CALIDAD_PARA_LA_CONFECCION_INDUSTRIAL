  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Gestión de información de las inspecciones de calidad

    p.mb-4 La administración de la información relacionada con la calidad se debe manejar con alta seguridad, para evitar alteraciones o pérdida de información que puedan afectar los resultados, los cuales se tendrán en cuenta para la toma de decisiones, las cuales deben ser tomadas de manera acertada.
    ...
    .row.justify-content-center(data-aos="fade")
      ...
      .col-lg-4
        img.mb-3.w-45x(src='@/assets/curso/temas/t1/3.png', alt='')
        p También es necesario estructurar la comunicación con todas las áreas y procesos de la empresa, realizando el seguimiento y consiguiendo las metas propuestas.
        p En el caso de los soportes de las inspecciones, los reportes deben estar diligenciados en formatos, dentro de los cuales es importante que se encuentre de manera clara y completa la información para realizar los análisis de la información.


    Separador
    #t_1_1.titulo-segundo.color-acento-contenido(data-aos='fade-right')
      h2 1.1 Herramientas TIC para registro de información
    ...
    p.mb-4 Algunas tecnologías utilizadas para el manejo de bases de datos son:
      ...
      .col-lg-7.mb-4.mb-lg-0
        ol.lista-ol--cuadro.lista-ol--separador.fa-lista
          ...
          li    
            ...
            span.mb-0 Bases de datos geoespaciales.
      .col-lg-3
        ol.lista-ol--cuadro.lista-ol--separador.fa-lista
          li    
            .lista-ol--cuadro__vineta
    ...
    #t_1_2.titulo-segundo.color-acento-contenido(data-aos='fade-right')
      h2 1.2 Sistema de información de calidad
              ...
              .col-lg-9
                ...
                SlyderF.circl-arrow(columnas="col-md-6 col-lg-4")
                  .tarjeta.bg3.p-4
                    ...
                    h4.bg-color-primario.w-fit.m-auto.text-white.text-center.py-1.px-4 Flexible
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj1-2.png' alt='')
                    h4.bg-color-primario.w-fit.m-auto.text-white.text-center.py-1.px-4 Seguro
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj1-3.png' alt='')
                    h4.bg-color-primario.w-fit.m-auto.text-white.text-center.py-1.px-4 Fácil de usar
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj1-4.png' alt='')
                    h4.bg-color-primario.w-fit.m-auto.text-white.text-center.py-1.px-4 Nivel de automatización
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-lg-9(data-aos="fade-left")
        ...
        ul.lista-ul.fa-lista.list-ico.mb-0
          li.mb-2
            img(src='@/assets/curso/temas/t1/ico-list.svg')
            span.mb-0 #[b Área de servicio al cliente y ventas:] devoluciones, reclamos, datos de los clientes, información de ventas.
          li.mb-2
            img(src='@/assets/curso/temas/t1/ico-list.svg')
            span.mb-0 #[b Área de diseño:] seguimientos y evaluaciones de muestras y lote piloto.
          li.mb-2
            img(src='@/assets/curso/temas/t1/ico-list.svg')
            span.mb-0 #[b Área de compras:] información de proveedores, pruebas de laboratorios a textiles, insumos, inspecciones a insumos y textiles.
          li.mb-2
            img(src='@/assets/curso/temas/t1/ico-list.svg')
            span.mb-0 Inspecciones de producto en proceso.
          li.mb-2
            img(src='@/assets/curso/temas/t1/ico-list.svg')
      ...
      .col-lg-7(data-aos="fade-left")
        ...
        ul.lista-ul--color.fa-lista.mb-0
          li.mb-0
            ...
            span.mb-0 #[b Información general:] datos sobre la fecha de presentación de la falla, fecha del reporte, responsable del reporte.
          li.mb-0
            i.far.fa-check-circle
            span.mb-0 #[b Detalle de los hechos:] descripción de la falla o error en orden cronológico y especificando los recursos y personas que se relacionan con la ocurrencia de la falla o error.
          li.mb-0
            i.far.fa-check-circle
            span.mb-0 Causa u origen de la falla o error.
          li.mb-0
            i.far.fa-check-circle
            span.mb-0 Análisis de causas y consecuencias.
          li.mb-0
            i.far.fa-check-circle
            span.mb-0 Revisiones realizadas.
          li.mb-0
            i.far.fa-check-circle
    ...
    .subt.mb-4(data-aos="fade-right")
      img(src='@/assets/curso/temas/t1/subt.svg', alt='')
      h3.mb-0 Recopilar datos de inspecciones
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-lg-8
            ul.lista-ul.fa-lista.list-ico.mb-0
              ...
              li
                img(src='@/assets/curso/temas/t1/ico-list.svg')
                span.mb-0 Cuestionarios.
              li
                img(src='@/assets/curso/temas/t1/ico-list.svg')
                span.mb-0 Entrevistas individuales o en grupo.
              li
                img(src='@/assets/curso/temas/t1/ico-list.svg')
                span.mb-0 Observaciones directas.
              li.mb-0
                img(src='@/assets/curso/temas/t1/ico-list.svg')
                span.mb-0 Informes.
      .col-lg-5.d-none.d-lg-block(data-aos="fade-left")
    ...
    .subt.mb-4(data-aos="fade-right")
      img(src='@/assets/curso/temas/t1/subt.svg', alt='')
      h3.mb-0 Disponibilidad para consultas
        ...
        .tarjeta--container.row
          .col-md.tarjeta.color-secundario.p-4
            ...
            ul.lista-ul--color.fa-lista.mb-0
              li
                i.far.fa-check-circle
                span.mb-0.text-white Fomentar la gestión del desempeño.
              li
                i.far.fa-check-circle
                span.mb-0.text-white Articular la planeación y la evaluación.
              li
                i.far.fa-check-circle
                span.mb-0.text-white Motivar la capacitación con los resultados de las evaluaciones de indicadores y demás resultados relacionados con la calidad.
              li.mb-0
                i.far.fa-check-circle
          ...
          .col-md.tarjeta.bg7.p-4
            ...
            ul.lista-ul--color.fa-lista.mb-0
              li.mb-0
                i.far.fa-check-circle
                span.mb-0.text-white Definir los indicadores de gestión adecuados.
              li.mb-0
                i.far.fa-check-circle
                span.mb-0.text-white Programar los seguimientos necesarios.
              li.mb-0
                i.far.fa-check-circle
                span.mb-0.text-white Compartir la información con el equipo de calidad y las demás personas involucradas en la gestión de la empresa.
              li.mb-0
                i.far.fa-check-circle
                span.mb-0.text-white Definir los recursos necesarios para las actividades de seguimiento.
              li.mb-0
                i.far.fa-check-circle
    ...
    .mb-4(data-aos="fade-down")
      .titulo-sexto.color-secundario.mb-3
        h5 Tabla 2. 
        span Análisis de índice de capacidad potencial
      .tabla-a.tabla1.tabl-resp.color-acento-contenido
        table
          thead
            tr.bg-color-secundario
      ...
      .col-lg-12.col-12.px-lg-4
        .row.justify-content-center.align-items-center
            ...
            .row.justify-content-center.align-items-center       
              ...
              .col-lg-9
                p Una vez se evalúe que el proceso no cumple con las especificaciones se deben adoptar algunas medidas:
                SlyderF.circl-arrow(columnas="col-md-6 col-lg-4")
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj7-1.png' alt='')
                    p.text-center Plantear estrategias para mejorar el proceso.
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj7-2.png' alt='')
                    p.text-center Cambiar el proceso.
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj7-3.png' alt='')
                    p.text-center Rediseñar la prenda.
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj7-4.png' alt='')
                    p.text-center Permitir aceptar el proceso.
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
                        img(src='@/assets/curso/temas/t1/tarj7-5.png' alt='')
                    p.text-center No hacer el proceso o el producto.
                  .tarjeta.bg3.p-4
                    .row.justify-content-center.mb-3
                      .col-5.col-lg-7.col-md-6
